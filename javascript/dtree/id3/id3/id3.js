/*
Implementção original
Fernando Simeone
Isaías Alves Ferreira
Modificado por Fernando Andrade
*/
//var i = 0;
//var valorEntropia = [];
(function() {
	...
	ID3.prototype.getAtributoMelhorClassificador = function(nodo) {
		...
		//console.log("Melhor atributo: "+melhorAtributo.nome);
	...
	ID3.prototype.calcularEntropia = function(dados, registrosConsiderados) {
		...
		//console.log("Entropia total: "+soma);
		return soma;
	};
	...
	ID3.prototype.calcularEntropiaAtributo = function(dados, atributo) {
		...
		//console.log("I("+atributo.nome+") = "+soma);
		//valorEntropia.push("I("+atributo.nome+") = "+soma);
		mostarEntropia("I("+atributo.nome+") = "+soma);
		return soma;
	};
